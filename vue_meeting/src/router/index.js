    ...
    children: [
      {
        ...
        name: 'Application',
        meta: { name: '应用管理', title: 'application', icon: 'component', noCache: true, }
      },
      {
        hidden: true,//不再菜单中显示
        path: 'detail',
        ...
        meta: { name: '应用详情', title: 'applicationDetail',  noCache: true,subPage:true}
      },
      {
        hidden: true,//不再菜单中显示
        path: 'add',
        ...
        name: 'applicationAdd',
        meta: {  name: '创建应用',title: 'addApplication',  noCache: true ,subPage:true}
      }
    ]
  },
    ...
    children: [
      {
        ...
        name: 'customer',
        meta: { name: '客户管理', title: 'customer', icon: 'peoples', noCache: true}
      },
      {
        hidden: true,//不再菜单中显示
        path: 'detail',
        ...
        name: 'customerDetail',
        meta: {name: '用户详情', title: 'detail',  noCache: true,subPage:true }
      },
      {
        hidden: true,//不再菜单中显示
        path: 'appDetail',
        ...
        meta: { name: '用户应用详情', title: 'appDetail',  noCache: true,subPage:true }
      }
    ...
    children: [
      {
        ...
        name: 'orderDetail',
        meta: { name: '订单详情',title: 'orderDetail', icon: 'excel', noCache: true ,subPage:true,permission: ['a_order_detail','a_order:all','a_order:list']}
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        name: 'finance',
        meta: { name: '财务管理', title: 'finance', icon: 'money', noCache: true}
      }
    ]
  },

  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'MyBooking',
        meta: { name: '我预约的', title: 'MyBooking', icon: 'user', noCache: true }
      },
      {
        path: 'myjoin',
      ...
      },
      {
        ...
        name: 'CheckMeeting',
        meta: { name: '会议审核', title: 'CheckMeeting', icon: 'user', noCache: true }
      },
      {
        path: 'equipmentmanagement',
        component: () => import('@/views/admin/EquipmentManagement'),
        name: 'EquipmentManagement',
        meta: { name: '设备管理', title: 'EquipmentManagement', icon: 'user', noCache: true }
      },
      {
        path: 'servicemanagement',
        component: () => import('@/views/admin/ServiceManagement'),
        name: 'ServiceManagement',
        meta: { name: '服务管理', title: 'ServiceManagement', icon: 'user', noCache: true }
      },
      {
        path: 'meetingroom',
